  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/Create" :name="$t('sidebar.Create')" icon="tim-icons icon-upload"/>
        <sidebar-link to="/Discover" :name="$t('sidebar.Discover')" icon="tim-icons icon-planet"/>
        <sidebar-link to="/Home" :name="$t('sidebar.Home')" icon="tim-icons icon-bag-16"/>
<!--        <sidebar-link to="/notifications" :name="$t('sidebar.notifications')" icon="tim-icons icon-bell-55"/>-->
        ...
        <sidebar-link to="/ControlPanel" :name="$t('sidebar.ControlPanel')" icon="tim-icons icon-puzzle-10"/>
